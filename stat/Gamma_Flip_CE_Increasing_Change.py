...
average_close_change_given_gamma_flip_ce_and_call_wall_ce_increases = (
    data_new['Close Change'][gamma_flip_ce_and_call_wall_ce_increases].mean() * 100
)
total_gamma_flip_ce_and_call_wall_ce_increases = gamma_flip_ce_and_call_wall_ce_increases.sum()
num_close_increases_given_gamma_flip_ce_and_call_wall_ce_increases = data_new['Close Change'][gamma_flip_ce_and_call_wall_ce_increases].gt(0).sum()
...
average_close_change_given_all_increases = (
    data_new['Close Change'][gamma_flip_ce_call_wall_ce_put_wall_ce_increases].mean() * 100
)
total_all_increases = gamma_flip_ce_call_wall_ce_put_wall_ce_increases.sum()
num_close_increases_given_all_increases = data_new['Close Change'][gamma_flip_ce_call_wall_ce_put_wall_ce_increases].gt(0).sum()
...
summary_table_increase = pd.DataFrame({
    "Condition": [
        "Gamma Flip CE Increases",
        "Gamma Flip CE Increases for 3 Consecutive Days",
        "Gamma Flip CE and Call Wall CE Both Increase",
        "Gamma Flip CE, Call Wall CE, and Put Wall CE All Increase"
    ],
    "Average Increase (%)": [
        stats_flip_ce_increase[0] * 100 if stats_flip_ce_increase[0] is not None else None,
        stats_flip_ce_consecutive_increase[0] * 100 if stats_flip_ce_consecutive_increase[0] is not None else None,
        average_close_change_given_gamma_flip_ce_and_call_wall_ce_increases,
        average_close_change_given_all_increases
    ],
    "Probability of Increase (%)": [
        stats_flip_ce_increase[1],
        stats_flip_ce_consecutive_increase[1],
        probability_close_increases_given_gamma_flip_ce_and_call_wall_ce_increases,
        probability_close_increases_given_all_increases
    ],
    "Total Instances": [
        stats_flip_ce_increase[2],
        stats_flip_ce_consecutive_increase[2],
        total_gamma_flip_ce_and_call_wall_ce_increases,
        total_all_increases
    ],
    "Number of Increases": [
        stats_flip_ce_increase[3],
        stats_flip_ce_consecutive_increase[3],
